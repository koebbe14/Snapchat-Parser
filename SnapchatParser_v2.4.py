import os, sys, io, re, json, zipfile, tempfile, shutil, logging, datetime, requests, csv, html, urllib.request, urllib.error, ssl, webbrowser
...
from PyQt5.QtWidgets import (
    ...
    QGraphicsBlurEffect, QScrollArea, QAction, QToolButton, QTableView, QTabWidget, QColorDialog
)
...
class HelpDialog(QDialog):
    ...
    def generate_help_content(self, tag_colors):
        ...
        html += "<tr><td><b>Version:</b></td><td>2.4</td></tr>"
...
class ExportOptionsDialog(QDialog):
    def __init__(self, parent=None):
        ...
        # Set a reasonable fixed size instead of screen percentage
        self.resize(600, 650)
        ...
        scope_layout.setContentsMargins(10, 25, 10, 10)  # Top margin for spacing below header
        scope_layout.addSpacing(20)  # Double blank line spacing after header
        ...
        sanitize_layout.setContentsMargins(10, 25, 10, 10)  # Top margin for spacing below header
        sanitize_layout.addSpacing(20)  # Double blank line spacing after header
        ...
        # Color mode selection (only for HTML)
        ...
        # Default to current application mode
        ...
        fields_layout.setContentsMargins(10, 25, 10, 10)  # Top margin for spacing below header
        fields_layout.addSpacing(20)  # Double blank line spacing after header
    ...
    def get_options(self):
        return {
            ...
            'export_color_mode': self.color_mode_combo.currentText(),  # "Light Mode" or "Dark Mode"
...
class ZipLoaderThread(QThread):
    finished_indexing = pyqtSignal(list, dict, list, list, dict, str, str)  # error_message, warnings
    ...
    def run(self):
        ...
        self.finished_indexing.emit(all_messages, conversations, basenames, conv_files, token_index, error_message, warnings)
...
class SnapParserMain(QMainWindow):
    ...
    def process_zip_data(self, all_messages, conversations, basenames, conv_files, token_index, error_message, warnings=""):
        if error_message:
